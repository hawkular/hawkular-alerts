...
public class EmailTemplateTest {
    ...
    public void defaultTemplate() throws Exception {
        Map<String, String> content = template.body(null, alertThreshold);
    ...
    public void templateForLocale() throws Exception {
        ...
        Map<String, String> content = template.body(props, alertThreshold);
        assertEquals(enTemplate, content.get("plain"));

        props.put(EmailPlugin.PROP_TEMPLATE_LOCALE, "es");
        content = template.body(props, alertThreshold);
    ...
    public void testBody() throws Exception {
        ...
        Map<String, String> body = template.body(props, alertAvailability);
        assertNotNull(body);
        ...
        body = template.body(props, alertThreshold);
        assertNotNull(body);
        assertNotNull(body.get("plain"));
        assertNotNull(body.get("html"));
