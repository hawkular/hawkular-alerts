 ...
 */
package org.hawkular.alerts.actions.aerogear.registration;
...
/**
 * A initialization class to init the Aerogear plugin
 *
...
public class RegistrationInit {
    ...
    public void init() {
        try {
            ...
            apMsg.setOp("init");
            apMsg.setActionPlugin("aerogear");
            ...
            msgLog.infoPluginRegistration("aerogear", mid.toString());
        } catch (JMSException e) {
            log.debug(e.getMessage(), e);
            msgLog.errorCannotSendMessage("aerogear", e.getMessage());
        }
    }
}
