...
/**
 * Cluster Group ITest on a suite to have better control of execution
 *
...
@Suite.SuiteClasses([
        ...
        // EventsAggregationExtensionITest.class - It requires cluster support for listeners
        GroupITest.class,
