...
import static org.hawkular.alerts.engine.cassandra.EmbeddedConstants.CASSANDRA_CONFIG;
import static org.hawkular.alerts.engine.cassandra.EmbeddedConstants.CASSANDRA_LISTEN_ADDRESS_DEFAULT;
import static org.hawkular.alerts.engine.cassandra.EmbeddedConstants.CASSANDRA_NATIVE_PORT_DEFAULT;
import static org.hawkular.alerts.engine.cassandra.EmbeddedConstants.CASSANDRA_YAML;
import static org.hawkular.alerts.engine.cassandra.EmbeddedConstants.HAWKULAR_ALERTS;
import static org.hawkular.alerts.engine.cassandra.EmbeddedConstants.JBOSS_DATA_DIR;
...
public class ConfigEditor {
    ...
    public void initEmbeddedConfiguration() throws Exception {
        ...
        File basedir = new File(System.getProperty(JBOSS_DATA_DIR, "./"));
        ...
        if (yamlFile.exists()) {
            ...
            this.setClusterName(HAWKULAR_ALERTS);
