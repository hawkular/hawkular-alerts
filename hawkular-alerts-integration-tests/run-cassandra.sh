...
CASSANDRA_DOWNLOADS="${TARGET_DIR}/cassandra-downloads"
...
CASSANDRA_HOME="${TARGET_DIR}/cassandra"
...
nohup sh ${CASSANDRA_HOME}/bin/cassandra -f -p ${TARGET_DIR}/cassandra.pid > ${CASSANDRA_HOME}/logs/stdout.log 2>&1 &
