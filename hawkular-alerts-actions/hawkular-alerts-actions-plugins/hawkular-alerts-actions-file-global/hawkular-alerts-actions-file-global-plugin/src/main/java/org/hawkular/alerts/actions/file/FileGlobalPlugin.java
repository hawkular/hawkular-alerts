...
/**
 * An example of global plugin that creates a copy of all actions on disk
 *
 * @author Lucas Ponce
 */
@Global
...
public class FileGlobalPlugin implements ActionPluginListener {
    ...
    public FileGlobalPlugin() {
        defaultProperties.put("path",
                new File(System.getProperty("java.io.tmpdir"), "hawkular/alerts/actions/file/global").getAbsolutePath());
