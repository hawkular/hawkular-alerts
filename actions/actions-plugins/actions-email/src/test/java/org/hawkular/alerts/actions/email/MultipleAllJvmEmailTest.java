 ...
 * @author Lucas Ponce
 */
public class MultipleAllJvmEmailTest extends CommonTest {
    ...
    public void writeAcknowledgeEmailTest() throws Exception {
        Alert openAlert = MultipleAllJvmData.getOpenAlert();
        Alert ackAlert = MultipleAllJvmData.ackAlert(openAlert);
    ...
    public void writeResolvedEmailTest() throws Exception {
        Alert openAlert = MultipleAllJvmData.getOpenAlert();
        Alert ackAlert = MultipleAllJvmData.ackAlert(openAlert);
        Alert resolvedAlert = MultipleAllJvmData.resolveAlert(ackAlert);
