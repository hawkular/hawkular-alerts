 ...
 * @author Lucas Ponce
 */
public class WebActiveSessionsEmailTest extends CommonTest {
    ...
    public void writeOpenEmailTest() throws Exception {
        Alert openAlert = WebActiveSessionsData.getOpenAlert();
    ...
    public void writeAcknowledgeEmailTest() throws Exception {
        Alert openAlert = WebActiveSessionsData.getOpenAlert();
        Alert ackAlert = WebActiveSessionsData.ackAlert(openAlert);
    ...
    public void writeResolvedEmailTest() throws Exception {
        Alert openAlert = WebActiveSessionsData.getOpenAlert();
        Alert ackAlert = WebActiveSessionsData.ackAlert(openAlert);
        Alert resolvedAlert = WebActiveSessionsData.resolveAlert(ackAlert);
