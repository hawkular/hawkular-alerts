 ...
 * @author Lucas Ponce
 */
public class JvmNonHeapUsageEmailTest extends CommonTest {
    ...
    public void writeOpenEmailTest() throws Exception {
        Alert openAlert = JvmNonHeapUsageData.getOpenAlert();
    ...
    public void writeAcknowledgeEmailTest() throws Exception {
        Alert openAlert = JvmNonHeapUsageData.getOpenAlert();
        Alert ackAlert = JvmNonHeapUsageData.ackAlert(openAlert);
    ...
    public void writeResolvedEmailTest() throws Exception {
        Alert openAlert = JvmNonHeapUsageData.getOpenAlert();
        Alert ackAlert = JvmNonHeapUsageData.ackAlert(openAlert);
        Alert resolvedAlert = JvmNonHeapUsageData.resolveAlert(ackAlert);
