 ...
 * @author Lucas Ponce
 */
public class JvmHeapUsageEmailTest extends CommonTest {
    ...
    public void writeOpenEmailTest() throws Exception {
        Alert openAlert = JvmHeapUsageData.getOpenAlert();
    ...
    public void writeAcknowledgeEmailTest() throws Exception {
        Alert openAlert = JvmHeapUsageData.getOpenAlert();
        Alert ackAlert = JvmHeapUsageData.ackAlert(openAlert);
    ...
    public void writeResolvedEmailTest() throws Exception {
        Alert openAlert = JvmHeapUsageData.getOpenAlert();
        Alert ackAlert = JvmHeapUsageData.ackAlert(openAlert);
        Alert resolvedAlert = JvmHeapUsageData.resolveAlert(ackAlert);
