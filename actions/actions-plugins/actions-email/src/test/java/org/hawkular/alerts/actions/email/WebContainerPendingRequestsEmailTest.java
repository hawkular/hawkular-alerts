...
import org.hawkular.alerts.actions.tests.WebContainerPendingRequestsData;
 ...
 * @author Lucas Ponce
 */
public class WebContainerPendingRequestsEmailTest extends CommonTest {
    ...
    public void writeAcknowledgeEmailTest() throws Exception {
        Alert openAlert = WebContainerPendingRequestsData.getOpenAlert();
        Alert ackAlert = WebContainerPendingRequestsData.ackAlert(openAlert);
    ...
    public void writeResolvedEmailTest() throws Exception {
        Alert openAlert = WebContainerPendingRequestsData.getOpenAlert();
        Alert ackAlert = WebContainerPendingRequestsData.ackAlert(openAlert);
        Alert resolvedAlert = WebContainerPendingRequestsData.resolveAlert(ackAlert);
