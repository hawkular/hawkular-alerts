...
import org.hawkular.alerts.actions.tests.UrlResponseTimeData;
 ...
 * @author Lucas Ponce
 */
public class UrlResponseTimeEmailTest extends CommonTest {
    ...
    public void writeOpenEmailTest() throws Exception {
        Alert openAlert = UrlResponseTimeData.getOpenAlert();
    ...
    public void writeAcknowledgeEmailTest() throws Exception {
        Alert openAlert = UrlResponseTimeData.getOpenAlert();
        Alert ackAlert = UrlResponseTimeData.ackAlert(openAlert);
    ...
    public void writeResolvedEmailTest() throws Exception {
        Alert openAlert = UrlResponseTimeData.getOpenAlert();
        Alert ackAlert = UrlResponseTimeData.ackAlert(openAlert);
        Alert resolvedAlert = UrlResponseTimeData.resolveAlert(ackAlert);
