...
import org.hawkular.alerts.actions.tests.WebRequestsResponseTimeData;
 ...
 * @author Lucas Ponce
 */
public class WebRequestsResponseTimeEmailTest extends CommonTest {
    ...
    public void writeOpenEmailTest() throws Exception {
        Alert openAlert = WebRequestsResponseTimeData.getOpenAlert();
    ...
    public void writeAcknowledgeEmailTest() throws Exception {
        Alert openAlert = WebRequestsResponseTimeData.getOpenAlert();
        Alert ackAlert = WebRequestsResponseTimeData.ackAlert(openAlert);
    ...
    public void writeResolvedEmailTest() throws Exception {
        Alert openAlert = WebRequestsResponseTimeData.getOpenAlert();
        Alert ackAlert = WebRequestsResponseTimeData.ackAlert(openAlert);
        Alert resolvedAlert = WebRequestsResponseTimeData.resolveAlert(ackAlert);
