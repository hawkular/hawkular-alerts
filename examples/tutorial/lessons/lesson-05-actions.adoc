...
Actions are tied to life-cycle.  Most actions are performed when an alert is created and moved to OPEN.  But hAlerting also allows actions to be performed on any life-cycle state transistion.  Revisiting the diagram from lesson-04, we can perform actions on any of the arrow transistions:
...
__Coming Soon! Lesson 06 - Events__
