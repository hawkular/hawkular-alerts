...
public class ActionPluginRegistrationListener extends BasicMessageListener<BusPluginRegistrationMessage>  {
    ...
    @Override
    protected void onBasicMessage(BusPluginRegistrationMessage msg) {
